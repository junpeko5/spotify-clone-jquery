...
class Account {
  ...
  private function insertUserDetails($un, $fn, $ln, $em, $pw) {
    ...
    $query = "
      ...
      VALUES 
      (  
        '$un', '$fn', '$ln', '$em', '$encriptPassword', '$date', '$profilePic'
      )
      ";
  ...
  private function validateEmails($em, $em2) {
    ...
    //TODO: Check that username hasn't alrady been used
    $checkEmailQuery = mysqli_query(
      $this->con,
      "SELECT username FROM users WHERE email = '$em'"
    );
