...
<script>
  $(document).ready(function() {
    ...
    $(".playbackBar .progressBar").on('mousedown', function() {
      mouseDown = true;
    });

    $(".playbackBar .progressBar").on('mousemove', function(e) {
      if(mouseDown) {
        timeFromOffset(e, this);
      }
    });

    $(".playbackBar .progressBar").on('mouseup', function(e) {
      timeFromOffset(e, this);
    });

    $(".volumeBar .progressBar").on('mousedown', function() {
      mouseDown = true;
    });
